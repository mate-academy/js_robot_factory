...
BaseRobot.prototype.goForward = function(step = 0) {
  this.coords.y += step;
};

BaseRobot.prototype.goBack = function(step = 0) {
  this.coords.y -= step;
};

BaseRobot.prototype.goRight = function(step = 0) {
  this.coords.x += step;
};

BaseRobot.prototype.goLeft = function(step = 0) {
  this.coords.x -= step;
};
