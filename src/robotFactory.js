...
// goForward, goBack, goRight and goLeft methods take a step
// argument (1 by default) and move the robot by step
// in the appropriate direction
// getInfo method returns a string in the next format
...
// in addition to FlyingRobot's args it takes maxLoadWeight and
// currentLoad and saves them.
// currentLoad should be set to null if not passed
// has hookLoad method taking a cargo object and
// saving it to a currentLoad property if it is empty and
// the cargo.weight is not greater than the maxLoadWeight of the drone.
...
class DeliveryDrone extends FlyingRobot {
  constructor(
    ...
    super(name, weight, x, y, z, chipVersion);
